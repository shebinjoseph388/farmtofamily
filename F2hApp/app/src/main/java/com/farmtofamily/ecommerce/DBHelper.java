...
public class DBHelper extends SQLiteOpenHelper{
	...
	/*private static final String TABLE_NAME1 = "History";
	...
	private static final String KEY_PSTATUS = "pstatus";
	private static final String KEY_PQUANTITY = "pquantity";*/
...
/*
		String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME + "("
				+ ID + " INTEGER NOT NULL," + MENU_NAME + " VARCHAR,"
				+ QUANTITY + " INTEGER," + TOTAL_PRICE + " NUMERIC," + TAX + " NUMERIC);";
...
//		onCreate(db);
	...
	/** this code is used to get all data from database */
 	...
 	public void addData(long id, String menu_name,double tax, int quantity, double total_price){
