...
class AdapterCategoryList extends BaseAdapter {
		...
		public int getCount() {
			...
			return Activity_Home1.Category_ID.size();
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			*/
			holder.txtText.setText(Activity_Home1.Category_name.get(position));
			imageLoader.DisplayImage(Constant.AdminPageURL+Activity_Home1.Category_image.get(position), holder.imgThumb);
